...
from config.settings import MPC_URL, BMS_URL, CLOUD_EVENT_URL, PROXIES
...
@allure.feature("[PTCM-14008]充电结束服务小结上传")
class TestPowerFinishChargeOss14008:
    ...
    @allure.story(f"PTCM-14008:检查充电结束服务小结: event_id: 800001, {finish_charge_oss}")
