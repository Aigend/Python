...
def generate_message(vin, vid=None, sample_ts=None, protobuf_v=pb2.VERSION, adas_header_data=None, tsp_log_list=None,
    ...
    """
    tsp_logs = TspLogList2()

    tsp_logs.vehicle_uuid = str(uuid.uuid1())
    tsp_logs.adc_version = 'BL061' if adc_version is None else adc_version
    tsp_logs.vehicle_id = vid
    ...
    tsp_log_list_event = {'AdasHeader': adas_header, event_type: tsp_logs}
