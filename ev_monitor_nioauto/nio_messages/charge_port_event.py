...
def generate_message(vin, vid=None, protobuf_v=pb2.VERSION, sample_ts=None, door_status=None, clear_fields=None):
    ...
    :param sample_ts: 采样时间
    :param door_status: 车门状态数据，默认为None表示随机取值
    :return:包含充电口事件消息的nextev_msg以及charge_end_msg本身
    """
    ...
    nextev_msg = gen_nextev_message('charge_port_event',
