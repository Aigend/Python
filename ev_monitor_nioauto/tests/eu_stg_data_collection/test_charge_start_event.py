...
class TestChargeStartMsg(object):
    ...
    def test_charge_start_event(self, publish_msg, checker, prepare, vid, kafka):
        ...
        nextev_message, charge_start_obj = publish_msg('charge_start_event', sleep_time=30,
        ...
        charge_start_obj['battery_package_info']['btry_pak_encoding'][0]['re_encoding'] = None
        charge_start_obj['battery_package_info']['btry_pak_encoding'][0]['nio_encoding'] \
            = charge_start_obj['battery_package_info']['btry_pak_encoding'][0]['nio_encoding'][:27]
