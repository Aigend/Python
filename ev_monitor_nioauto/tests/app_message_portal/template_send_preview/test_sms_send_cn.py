...
class TestTemplateSend(object):
    ...
    sms_template_send_cn_gat_cases = [
        ...
        # ("正案例_普通短信_大陆", "SMS_L_R_no_repeat_portal_sms", "all", "recipient", "+8617610551933"),
        # ("正案例_普通短信_香港", "SMS_L_R_no_repeat_portal_sms", "all", "recipient", "+85217610551933"),
        # ("正案例_普通短信_澳门", "SMS_L_R_no_repeat_portal_sms", "all", "recipient", "+85317610551933"),
        # ("正案例_普通短信_台湾", "SMS_L_R_no_repeat_portal_sms", "all", "recipient", "+88617610551933"),
    ]
