...
eu_email_preview = "/api/2/in/message_portal/template/eu/email/preview"
app_id = 10000
...
class TestTemplateReview(object):
    ...
    def test_email_template_review_eu(self, env, cmdopt, mysql, case_name, template_name, replace_values, user_key, prepare_template, prepare_eu_email_account):
        """
