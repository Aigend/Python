...
from tests.app_message_portal.variable_management.variable_server import extracted_private_variable_from_template, generate_private_variable_replace, verify_variable, \
    generate_global_private_variable_replace
...
class TestAppReview(object):
    ...
    app_template_preview_cases = [
        ...
        ("TOC_正案例_只有自定义变量模板_变量无重复", "APP_L_no_repeat", "all", "app_in", "nmp_app"),
        ...
        ("TOC_反案例_公共变量_部分有对应url", "APP_R_part_value", None, "app_in", "nmp_app"),
        ("TOC_反案例_公共变量_全部无对应url", "APP_R_no_value", None, "app_in", "nmp_app"),
        ("TOC_反案例_公共变量_部分用户有对应url", "APP_R_part_user", None, "app_in", "nmp_app"),
        ("TOC_反案例_自定义变量_部分字段有替换", "APP_L_part_value", "part_value", "app_in", "nmp_app"),
        ("TOC_反案例_自定义变量_全部字段无替换", "APP_L_no_value", None, "app_in", "nmp_app"),
        ("TOC_反案例_自定义变量_部分用户有替换", "APP_L_part_user", "part_user", "app_in", "nmp_app"),
        ("TOC_反案例_自定义变量_全部用户无替换", "APP_L_no_user", None, "app_in", "nmp_app"),
        ("TOC_反案例_公共变量+自定义变量模板_自定义变量全有替换值，公共变量只有部分字段有对应替换值", "APP_L_value_R_part_value", "all", "app_in", "nmp_app"),
        ("TOC_反案例_公共变量+自定义变量模板_自定义变量全有替换值，公共变量只有部分用户有对应替换值", "APP_L_user_R_part_user", "all", "app_in", "nmp_app"),
        ("TOC_反案例_公共变量+自定义变量模板_自定义变量全有替换值，公共变量无对应替换值", "APP_L_value_R_no_value", "all", "app_in", "nmp_app"),
        ("TOC_反案例_公共变量+自定义变量模板_公共变量全有替换值，自定义变量全部无替换值", "APP_R_L_no_value", None, "app_in", "nmp_app"),
        ("TOC_反案例_公共变量+自定义变量模板_公共变量全有替换值，自定义变量部分字段有替换值", "APP_R_L_part_value", "part_value", "app_in", "nmp_app"),
        ("TOC_反案例_公共变量+自定义变量模板_公共变量全有替换值，自定义变量部分用户有替换值", "APP_R_L_part_user", "part_user", "app_in", "nmp_app"),
        # TOB
        ...
        ("TOB_正案例_只有公共变量模板_变量有重复", "APP_TOB_R_repeat", None, "app_tob_in", "nmp_app_tob"),
        ("TOB_正案例_只有自定义变量模板_变量无重复", "APP_TOB_L_no_repeat", "all", "app_tob_in", "nmp_app_tob"),
        ...
        ("TOB_正案例_公共变量+自定义变量模板_变量不重复", "APP_TOB_L_R_no_repeat", "all", "app_tob_in", "nmp_app_tob"),
        ("TOB_反案例_公共变量_部分有对应url", "APP_TOB_R_part_value", None, "app_tob_in", "nmp_app_tob"),
        ("TOB_反案例_公共变量_全部无对应url", "APP_TOB_R_no_value", None, "app_tob_in", "nmp_app_tob"),
        ("TOB_反案例_公共变量_部分用户有对应url", "APP_TOB_R_part_user", None, "app_tob_in", "nmp_app_tob"),
        ("TOB_反案例_自定义变量_部分字段有替换", "APP_TOB_L_part_value", "part_value", "app_tob_in", "nmp_app_tob"),
        ("TOB_反案例_自定义变量_全部字段无替换", "APP_TOB_L_no_value", None, "app_tob_in", "nmp_app_tob"),
        ("TOB_反案例_自定义变量_部分用户有替换", "APP_TOB_L_part_user", "part_user", "app_tob_in", "nmp_app_tob"),
        ("TOB_反案例_自定义变量_全部用户无替换", "APP_TOB_L_no_user", None, "app_tob_in", "nmp_app_tob"),
        ("TOB_反案例_公共变量+自定义变量模板_自定义变量全有替换值，公共变量只有部分字段有对应替换值", "APP_TOB_L_value_R_part_value", "all", "app_tob_in", "nmp_app_tob"),
        ("TOB_反案例_公共变量+自定义变量模板_自定义变量全有替换值，公共变量只有部分用户有对应替换值", "APP_TOB_L_user_R_part_user", "all", "app_tob_in", "nmp_app_tob"),
        ("TOB_反案例_公共变量+自定义变量模板_自定义变量全有替换值，公共变量无对应替换值", "APP_TOB_L_value_R_no_value", "all", "app_tob_in", "nmp_app_tob"),
        ("TOB_反案例_公共变量+自定义变量模板_公共变量全有替换值，自定义变量全部无替换值", "APP_TOB_R_L_no_value", None, "app_tob_in", "nmp_app_tob"),
        ("TOB_反案例_公共变量+自定义变量模板_公共变量全有替换值，自定义变量部分字段有替换值", "APP_TOB_R_L_part_value", "part_value", "app_tob_in", "nmp_app_tob"),
        ("TOB_反案例_公共变量+自定义变量模板_公共变量全有替换值，自定义变量部分用户有替换值", "APP_TOB_R_L_part_user", "part_user", "app_tob_in", "nmp_app_tob"),
    ]
